Mudu.Init(
  ...
  185053,
    ...
    function () {
      ...
      var player = new Mudu.Player(
        ...
        //   src:'https://myun-hw-s3.myun.tv/melj80jz/lopm9460/1557918270120712989.m3u8',
  ...
  function open(){
    ...
    var Player = document.createElement('div');
    Player.setAttribute('id','J_prismPlayer');
    Player.setAttribute('class','prism-player');
    container.appendChild(Player);


    document.getElementsByClassName('backplay')[0].appendChild(container);
